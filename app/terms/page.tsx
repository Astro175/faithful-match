      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 px-[5em] mx-auto mb-12 max-w-[1100px]">
          ...
          <ol className="list-decimal space-y-6 pl-4">
            <li>
              ...
              <p className="text-foreground font-outfit">
                By using the Faithful Match app, you agree to abide by these
                Terms & Conditions. If you do not agree, please refrain from
                using the app.
              </p>
            </li>
            ...
            <li>
              ...
              <p className="text-foreground font-outfit">
                You must be at least 18 years old to use Faithful Match. By
                using the app, you confirm that you meet this age requirement.
              </p>
            </li>
            ...
            <li>
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground font-outfit">
                ...
                <li>
                  You agree not to impersonate others or create multiple
                  accounts.
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground font-outfit">
                ...
                <li>
                  Users must adhere to our community guidelines and respect
                  other users.
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <p className="text-foreground font-outfit">
                ...
                Policy for details on data collection, use, and protection.
              </p>
            </li>
            ...
            <li>
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground font-outfit">
                ...
                <li>
                  Do not share personal or financial information with other
                  users.
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <p className="text-foreground font-outfit">
                Faithful Match reserves the right to suspend or terminate
                accounts for violations of our terms or community guidelines.
              </p>
            </li>
            ...
            <li>
              ...
              <p className="text-foreground font-outfit">
                Faithful Match may update these Terms & Conditions. Users will
                be notified of changes, and continued use implies acceptance.
              </p>
            </li>
          ...
          <p className="text-foreground font-outfit mt-8">
            ...
            Conditions outlined above. Your privacy and security are important
            to us, and we are committed to providing a safe and enjoyable dating
            experience.
          </p>
        </main>
